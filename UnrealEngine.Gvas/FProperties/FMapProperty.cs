...
public class FMapProperty : FProperty
{
    ...
    public Dictionary<FProperty, FProperty> KeyValuePairs { get; set; } = new();

    public FMapProperty(Type? keyType, Type? valueType, Dictionary<FProperty, FProperty> keyValuePairs)
    {
        KeyType = keyType;
        ValueType = valueType;
